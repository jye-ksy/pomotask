...
export default function NewTaskForm() {
    ...
    return (
        <Form {...form}>
            ...
            >
                ...
                <FormField
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <RadioGroup className="flex space-x-2" defaultValue="NOT_STARTED">
                        ...
                        <FormItem>
                            ...
                            <Popover open={open} onOpenChange={setOpen}>
                                ...
                                <PopoverContent className="w-[200px] p-0">
                                    <Command>
                                    <CommandInput placeholder="Search for project..." className="h-9" />
            ...
            <Button className="" type="submit">Create Task</Button>
        </form>
      </Form>
    )
}